            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-8 text-success">
                        ...
                        <input type="text" name="nama" value="<?php echo $row['nama']; ?>" class="form-control" placeholder="Enter Name">
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="row">
                    <div class="col-md-8 text-success">
                        ...
                        <input type="text" name="no_hp" value="<?php echo $row['no_hp']; ?>" class="form-control" placeholder="Enter Telephone Number">
                    </div>
                </div>
            </div>
            <div class="form-group">
