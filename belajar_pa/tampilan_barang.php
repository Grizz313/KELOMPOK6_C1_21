...
<body>
  ...
  <div class="tabel col-md-11" style=" margin-left: 60px;">
        <h2 class="alert alert-dark text-center mt-5" style="background-color: #28a745">ITEM DATA DISPLAY</h2>
        <table rules="rows" class="table table-dark mt-2">
          <a href="forms.php" class="btn btn-success">ADD DATA</a>
          <thead>
              <tr>
              <th scope="col">No</th>
          ...
          <tbody>
              ...
              <tr>
                  ...
                  <td><?=$data['tanggal'] ?></td>
                  <td>
                    <a href="update_barang.php?id_barang=<?=$data['id_barang'] ?>" class="btn btn-success">Edit</a>
                    <a href="delete_barang.php?id_barang=<?=$data['id_barang'] ?>" class="btn btn-danger">Delete</a>
                  </td>
              </tr>
          <?php $i++; ?>
          <?php endwhile; ?>
